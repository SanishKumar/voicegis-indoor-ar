...
export interface CompiledBuildingPackageContent {
...
export interface CompiledBuildingPackage extends CompiledBuildingPackageContent {
  manifest: {
...
export interface CompilationPreparation {
  content: CompiledBuildingPackageContent | null;
...
export function prepareBuildingCompilation(value: unknown): CompilationPreparation {
  ...
  if (!report.valid) return { content: null, report };

  const content: CompiledBuildingPackageContent = {
